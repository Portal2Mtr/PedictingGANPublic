"""Credit Fraud Dataset Class

Managing class for the credit fraud dataset
...
class CreditFraudDataset(DatasetBase):

    def __init__(self,trainSplit=None):
        super(CreditFraudDataset, self).__init__()
        file_config = './config/dataconfig/creditfraudconfig.yml'
    ...
    def load_data(self):
        """
        Loads the credit fraud dataset.
        Returns:
        ...
        # Add noise to each sample for categorical values (should be none for credit)
        uniform_mag = 0.01
