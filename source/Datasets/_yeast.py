...
Managing class for the Yeast multiclass dataset.
...
class YeastDataset(DatasetBase):

    def __init__(self,trainSplit=None):
        super(YeastDataset, self).__init__()
        file_config = './config/dataconfig/yeastconfig.yml'
    ...
    def load_data(self):
        ...
        if self.load_idn:
            ...
            sep = ','
        dataframe = read_csv(fileload, sep=sep)
        # get the values
