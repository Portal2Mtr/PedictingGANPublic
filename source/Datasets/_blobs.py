...
Managing class for the Gaussian Blobs Dataset.
...
class BlobsDataset(DatasetBase):
    ...
    def __init__(self):
        super(BlobsDataset, self).__init__(majority_label=[0], minority_label=1, synth_label=2)
        file_config = './config/dataconfig/blobsconfig.yml'
    ...
    def load_data(self):
        ...
        data, labels = make_blobs(n_samples=self.size, centers=len(self.class_array),
                                 shuffle=False,
